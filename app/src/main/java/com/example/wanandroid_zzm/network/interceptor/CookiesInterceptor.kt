...
import com.example.wanandroid_zzm.network.KEY_SAVE_USER_LOGIN
import com.example.wanandroid_zzm.network.KEY_SAVE_USER_REGISTER
import com.example.wanandroid_zzm.network.KEY_SET_COOKIE
...
class CookiesInterceptor : Interceptor {
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if ((url.contains(KEY_SAVE_USER_LOGIN) || url.contains(KEY_SAVE_USER_REGISTER))
            ...
            val cookies = response.headers(/* name = */ KEY_SET_COOKIE)
